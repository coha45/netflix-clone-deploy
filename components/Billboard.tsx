    ...
    <div className="relative h-[56.25vw]">
        ...
        <div className="absolute top-[30%] md:top-[40%] ml-4 md:ml-16">
            ...
            <div className="flex flex-row items-center mt-3 md:mt-4 gap-3">
                ...
                <button onClick={handleModelOpen} className="bg-white text-white bg-opacity-30 rounded-md
                py-1 md:py-2 px-2 md:px-4 w-auto text-xs lg:text-lg font-semibold flex flex-row items-center
