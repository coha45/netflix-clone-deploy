            ...
            <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
                ...
                bg-zinc-900 drop-shadow-md`}>
                    <div className="relative h-96">
                        ...
                        muted 
                        loop
                        className="w-full brightnes-[60%] object-cover h-full"
                        src={data?.videoUrl} poster={data?.thumbnailUrl}></video>
                        <div onClick={handleClose} className="cursor-pointer absolute top-3 right-3 h-10 w-10 rounded-full bg-black 
